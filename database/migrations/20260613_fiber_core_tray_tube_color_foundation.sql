-- Fiber core tray/tube/color foundation.
-- Safe to run more than once.
--
-- Adds physical cable structure fields to fiber_cores without changing the
-- existing topology source of truth. Runtime APIs can continue using the old
-- fields until frontend/mobile are ready to display tray and tube data.
...
-- Backfill existing fiber_cores with default 12-color core and tube mapping.
with profile as (
  select id
